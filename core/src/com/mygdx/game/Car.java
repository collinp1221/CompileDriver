...
import com.mygdx.game.MapLoader;
import com.mygdx.game.Wheel;
...
public class Car extends BodyHolder {
    ...
    private static final Vector2 WHEEL_SIZE = new Vector2(200, 180);
    private static final float LINEAR_DAMPING = 0.9f;// reduction of force after "letting off gas"
    private static final float RESTITUTION = 0.2f;

    private static final float MAX_WHEEL_ANGLE = 20.0f;
    private static final float WHEEL_TURN_INCREMENT = 2.0f;

    private static final float WHEEL_OFFSET_X = 665;
    private static final float WHEEL_OFFSET_Y = 840;
     ...
     * @param world {@link com.mygdx.game.screens.PlayScreen#mWorld} used to control and add physics objects
     */
