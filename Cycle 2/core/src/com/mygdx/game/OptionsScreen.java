...
public class OptionsScreen extends ScreenAdapter {
    ...
    public OptionsScreen(MyGdxGame agame)
    {
        ...
        buzz.addListener(new ClickListener()
        {
            ...
            @Override
            public void clicked(InputEvent event, float x, float y) {
                buzzer.play(game.volume);
            }
        });

        final Slider volumeChanger = new Slider(0.0F,1.0F,0.1F,false,game.skin);
        volumeChanger.setPosition(150,260);
        volumeChanger.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                game.volume= volumeChanger.getValue();
            }
        });
        ...
        optionStage.addActor(volumeChanger);
